...
if __name__ == '__main__':
    ...
    print regex.compare_strings( False, [ "the cat and the mouse in the house is sitting, in the house, on the mat", "time is it?", "what time is it here?", "This is the cat's hat" ] )
